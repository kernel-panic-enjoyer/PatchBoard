...
<body>
  ...
  <main>
	...
	<section id="updates-section" class="panel table-panel priority-panel">
	  ...
	  <div class="table-footer split"><div class="button-row"><button id="update-selected-button" form="update-selected-form" type="submit"><span class="button-icon" aria-hidden="true"><svg viewBox="0 0 24 24"><path d="M5 12h14"/><path d="m13 6 6 6-6 6"/></svg></span><span>Update Selected</span></button><button id="select-all-updates" class="ghost" type="button">Select All</button><button id="select-no-updates" class="ghost" type="button">Select None</button></div><div class="table-pager"><button id="updates-prev" class="ghost" type="button" disabled>Previous</button><span id="updates-page-status" class="muted">Page 1</span><button id="updates-next" class="ghost" type="button" disabled>Next</button></div></div>
	</section>

	<section id="installed-section" class="panel table-panel">
	  <div class="section-heading"><div><span class="panel-kicker">Inventory</span><h2>Installed Packages</h2></div><div class="button-row"><button id="scan-button" class="ghost" type="button"><span class="button-icon" aria-hidden="true"><svg viewBox="0 0 24 24"><path d="M4 7V5a1 1 0 0 1 1-1h2"/><path d="M17 4h2a1 1 0 0 1 1 1v2"/><path d="M20 17v2a1 1 0 0 1-1 1h-2"/><path d="M7 20H5a1 1 0 0 1-1-1v-2"/><path d="M7 12h10"/></svg></span><span>Scan Apps</span></button><label class="sr-only" for="installed-search">Filter installed packages</label><input id="installed-search" class="table-search" type="search" placeholder="Filter installed packages" autocomplete="off"><label class="sr-only" for="installed-manager-filter">Filter installed packages by package manager</label><select id="installed-manager-filter" class="table-filter" aria-label="Filter installed packages by package manager"><option value="all">All managers</option><option value="winget">winget</option><option value="store">Microsoft Store</option><option value="choco">Chocolatey</option></select></div></div>
	  ...
	  <div class="table-footer"><div class="table-pager"><button id="installed-prev" class="ghost" type="button">Previous</button><span id="installed-page-status" class="muted">Page 1</span><button id="installed-next" class="ghost" type="button">Next</button></div></div>
	</section>
