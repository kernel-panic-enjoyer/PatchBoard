...
<body data-token="{{.Token}}">
  ...
  <main>
    ...
    <section id="dashboard-summary" class="summary-grid" aria-label="Dashboard summary">
      <article class="summary-card accent-update"><span class="summary-icon" aria-hidden="true"><svg viewBox="0 0 24 24"><path d="M21 12a9 9 0 1 1-2.6-6.4"/><path d="M21 4v6h-6"/></svg></span><div><p>Updates available</p><strong id="summary-updates">-</strong><span id="summary-updates-detail" class="muted">Checking packages</span></div></article>
      ...
      <article class="summary-card"><span class="summary-icon" aria-hidden="true"><svg viewBox="0 0 24 24"><path d="M7 8h10"/><path d="M7 12h10"/><path d="M7 16h6"/><rect x="4" y="4" width="16" height="16" rx="3"/></svg></span><div><p>Package managers</p><strong id="summary-managers">-</strong><span id="summary-managers-detail" class="muted">Checking tools</span></div></article>
      <article class="summary-card"><span class="summary-icon" aria-hidden="true"><svg viewBox="0 0 24 24"><path d="M12 6v6l4 2"/><circle cx="12" cy="12" r="9"/></svg></span><div><p>Automation</p><strong id="summary-automation">-</strong><span id="summary-automation-detail" class="muted">Loading tasks</span></div></article>
    </section>

    <section class="control-grid">
      <div class="panel manager-panel"><div class="section-heading"><h2>Package Managers</h2><span class="panel-kicker">Availability</span></div><div id="manager-list"><p class="muted">Checking package managers...</p></div></div>
    ...
    <section id="search-results-panel" class="panel table-panel hidden">
      <div class="section-heading"><h2>Search Results</h2><span class="panel-kicker">Installable packages</span></div>
	...
	<section id="updates-section" class="panel table-panel priority-panel">
	  ...
	  <div class="table-wrap"><table><thead><tr><th></th><th>Name</th><th>Manager</th><th>Installed</th><th>Available</th><th>Auto</th><th>Action</th></tr></thead><tbody id="updates-body"><tr><td colspan="7">Loading packages...</td></tr></tbody></table></div>
	...
	<section id="installed-section" class="panel table-panel">
	  <div class="section-heading"><div><span class="panel-kicker">Inventory</span><h2>Installed Packages</h2></div><div class="button-row"><input id="installed-search" class="table-search" type="search" placeholder="Filter installed packages"><button id="installed-prev" class="ghost" type="button">Previous</button><span id="installed-page-status" class="muted">Page 1</span><button id="installed-next" class="ghost" type="button">Next</button></div></div>
	  <div class="table-wrap"><table><thead><tr><th>Name</th><th>Manager</th><th>Installed</th><th>Available</th><th>Status</th><th>Auto</th><th>Action</th></tr></thead><tbody id="packages-body"><tr><td colspan="7">Loading packages...</td></tr></tbody></table></div>
	</section>
