...
| PR-02 | Critical | Cancellation | command runner | Cancellation and final wait paths can block indefinitely. | Bound terminate/wait/pipe-drain phases and return a typed timeout diagnostic. | 2 | in progress |
